...
import { mapApiToForm, mapApiToRows, buildSalesOrderFormData } from './salesOrderHelpers';
...
export default function SalesOrdersEdit() {
  ...
  const { currentOrder, loading, error, saveSuccess } = useSelector((state) => state.salesOrder);
