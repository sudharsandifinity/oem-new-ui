...
export default function SalesOrderList() {
  ...
  useEffect(() => {
    dispatch(getSalesOrders({ top: paginationModel.pageSize, skip: paginationModel.page * paginationModel.pageSize }));
  }, [paginationModel]);

  const { loading, error, orders, totalCount } = useSelector(
      ...
      renderCell: (params) => (
        ...
        >
          <IconButton
            ...
            color="primary"
            onClick={() =>
              navigate(`/sales-orders/view/${params.row.DocEntry}`)
            }
          >
            <VisibilityIcon
              fontSize="small"
