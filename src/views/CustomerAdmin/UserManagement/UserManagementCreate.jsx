...
import { createAdminUsers, resetAdminUserState } from '../../../store/slices/commonCustomerSlice';
import UserForm from './UserForm';
import { buildPayload } from './UMHelpers';
...
export default function UserManagementCreate() {
  ...
  const dispatch = useDispatch();
    const {  createLoading,saveSuccess,error } = useSelector((s) => s.commonCustomer);
  ...
  const handleSubmit = () => {
    ...
    dispatch(createAdminUsers(payload));
  };
