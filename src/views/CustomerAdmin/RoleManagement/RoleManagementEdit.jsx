...
export default function RoleManagementEdit() {
  const { id } = useParams();
  ...
  const handleSubmit = () => {
    dispatch(updateAdminRoles({ id: id, payload: buildPayload(form, lines) }));
  };
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 2 }}>
            ...
            <Box sx={{ display: 'flex', gap: 2 }}>
              ...
              <Button
                ...
                disabled={loading || updateroleLoading}
                startIcon={updateroleLoading ? <CircularProgress size={16} color="inherit" /> : null}
              >
                Update
              </Button>
            </Box>
