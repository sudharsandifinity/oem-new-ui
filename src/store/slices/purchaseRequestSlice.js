...
export const getPRList = createAsyncThunk(
  'purchaseRequest/getList',
...
const purchaseRequestSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(getPRList.pending,   (state) => { state.listLoading = true; state.error = null; })
      .addCase(getPRList.fulfilled, (state, action) => {
        state.listLoading = false;
        state.list        = action.payload.list;
        state.totalCount  = action.payload.totalCount;
      })
      .addCase(getPRList.rejected,  (state, action) => { state.listLoading = false; state.error = action.payload; })

      .addCase(getPRById.pending,   (state) => { state.currentPRLoading = true; state.currentPR = null; state.currentPRError = null; })
      .addCase(getPRById.fulfilled, (state, action) => { state.currentPRLoading = false; state.currentPR = action.payload; })
      .addCase(getPRById.rejected,  (state, action) => { state.currentPRLoading = false; state.currentPRError = action.payload || 'Failed to load'; })

      .addCase(createPR.pending,   (state) => { state.createLoading = true; state.error = null; state.saveSuccess = false; })
      .addCase(createPR.fulfilled, (state) => { state.createLoading = false; state.saveSuccess = true; })
